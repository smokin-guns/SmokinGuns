...
char *Sys_DefaultQ3AHomePath( const char *gamedir)
{
	...
	FILE *f;
	const char *p[]= {
		"F:\\Program Files\\Quake III Arena",
		"E:\\Program Files\\Quake III Arena",
		"D:\\Program Files\\Quake III Arena",
		"C:\\Program Files\\Quake III Arena",
		"C:\\Programme\\Quake III Arena",
		"C:\\Program\\Quake III Arena",
		"C:\\Programmi\\Quake III Arena",
		"C:\\Programmer\\Quake III Arena",
		"C:\\Archivos de Programa\\Quake III Arena",
		"C:\\Arquivos de Programas\\Quake III Arena",
		"C:\\Quake III Arena",
		NULL,
	};
	char *testpath;
	...
	for (i=0; p[i] != NULL ; i++) {
		testpath = FS_BuildOSPath( p[i], gamedir, "q3config.cfg" );
		f = fopen( testpath, "r" );
		if (f) {
			fclose( f );
			Q_strncpyz(homeq3aPath, p[i], sizeof(homeq3aPath));
			return homeq3aPath;
		}
	}
