#!/usr/bin/perl
#
#  A Western Quake 3 Duel Log Fix for VSP stat.
#  Copyright (c) 2007 Gilbert Cao (hika)
#  All rights reserved.
#
...
#
# v1.0
# The program is basically a fix in the log file provided by Western Quake 3 Duel.
