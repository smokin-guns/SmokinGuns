...
#else
#include "d:/quake3/source/code/qcommon/qfiles.h"
#include "d:/quake3/source/code/game/surfaceflags.h"
#endif
...
infoParm_t	infoParms[] = {
	...
	{ "wood",		0,	SURF_WOOD, 0 },
	{ "cloth",		0,	SURF_CLOTH, 0 },
	{ "dirt",		0,	SURF_DIRT, 0 },
	{ "glass",		0,	SURF_GLASS, 0},
	{ "plant",		0,	SURF_PLANT, 0},
	{ "sand",		0,	SURF_SAND, 0},
	{ "snow",		0,	SURF_SNOW, 0},
	{ "stone",		0,	SURF_STONE, 0},
	{ "water",		0,	SURF_WATER, 0},
