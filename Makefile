...
define DO_SMP_CC
$(echo_cmd) "SMP_CC $<"
$(Q)$(CC) $(BASEGAME_CFLAGS) $(SHLIBCFLAGS) $(CFLAGS) $(CLIENT_CFLAGS) $(OPTIMIZE) -DSMP -o $@ -c $<
endef
...
=======
$(B)/$(CLIENTBIN)-smp$(FULLBINEXT): $(Q3OBJ) $(Q3R2OBJ) $(Q3RPOBJ_SMP) $(JPGOBJ) $(LIBSDLMAIN)
>>>>>>> dfdfc65... From /dev/humancontroller:
	$(echo_cmd) "LD $@"
	$(Q)$(CC) $(CLIENT_CFLAGS) $(CFLAGS) $(CLIENT_LDFLAGS) $(LDFLAGS) $(THREAD_LDFLAGS) \
...
ifeq ($(PLATFORM),mingw32)
	...
	@if [ -d "$(LOKISETUPDIR)" ]; then $(MAKE) -C $(LOKISETUPDIR) clean ; fi
endif
